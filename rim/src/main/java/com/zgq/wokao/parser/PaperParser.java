...
public class PaperParser extends BaseParser implements IPaperParser {
    ...
    public PaperParser initParam() {
        ...
        paper = NormalExamPaper
                ...
                .fillInQuestions(new RealmList<FillInQuestion>())
                .tfQuestions(new RealmList<TFQuestion>())
                .sglChoQuestions(new RealmList<SglChoQuestion>())
                .multChoQuestions(new RealmList<MultChoQuestion>())
                .discussQuestions(new RealmList<DiscussQuestion>())
                .build();
        return this;
    }
    ...
    public NormalExamPaper parse(InputStream inputStream) throws ParseException {
        ...
        if (topics.size() == 0) {
            throw new ParseException("请检查大标题");
        }
