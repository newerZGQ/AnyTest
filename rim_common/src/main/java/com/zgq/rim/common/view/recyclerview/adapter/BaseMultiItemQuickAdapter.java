...
import com.zgq.rim.common.view.recyclerview.entity.MultiItemEntity;
...
public abstract class BaseMultiItemQuickAdapter<T extends MultiItemEntity>
    ...
    public BaseMultiItemQuickAdapter(Context context, List<T> data) {
        ...
        if (layouts == null || layouts.size() == 0) {
            throw new IllegalAccessError("Please add item use 'addItemType(" +
                    "int type, int layoutResId)' " + "in the 'attachItemType()' method");
        }
    }
