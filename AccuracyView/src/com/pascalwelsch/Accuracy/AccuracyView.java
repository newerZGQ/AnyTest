package com.pascalwelsch.Accuracy;
...
public class AccuracyView extends View {
     ...
     */
    public AccuracyView(final Context context) {
        this(context, null);
    }
    ...
    public AccuracyView(final Context context, final AttributeSet attrs,
        ...
        final TypedArray attributes = context
                .obtainStyledAttributes(attrs, R.styleable.AccuracyView,
                        defStyle, 0);
        if (attributes != null) {
            try {
                setProgressColor(attributes
                        .getColor(R.styleable.AccuracyView_progress_color, Color.CYAN));
